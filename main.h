...
void print_float_padding(fmt_info_t *fmt_info, double num, int num_len, int max_w, int zeros_count);
void print_float_number(fmt_info_t *fmt_info, double num, int num_len, char *str);
